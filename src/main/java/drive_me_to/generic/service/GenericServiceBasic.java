package drive_me_to.generic.service;
...
public abstract class GenericServiceBasic<T extends Data<ID>, ID> implements GenericService<T, ID> {
     ...
     */
    public GenericServiceBasic(JpaRepository<T, ID> repository) {
